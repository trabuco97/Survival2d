...
{
    public class UI_ItemDragImage : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (ui_canvas == null)
            {
                Debug.LogWarning($"{nameof(ui_canvas)} is not assigned to {nameof(UI_ItemDragImage)} of {name}");
            }

            if (ui_image == null)
            {
                Debug.LogWarning($"{nameof(ui_image)} is not assigned to {nameof(UI_ItemDragImage)} of {name}");
            }
#endif
