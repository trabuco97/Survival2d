...
{
    public abstract class UI_IItemSlot : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IDropHandler
    {
        ...
        [HideInInspector] public UI_ItemDrag item_drag_display = null;
        ...
        {
            var slot_displayed_startDrag = eventData.pointerDrag.GetComponent<UI_IItemSlot>();
