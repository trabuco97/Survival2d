...
{
    public class ItemPickGeneratorBehaviour : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                Debug.LogWarning($"{nameof(item_pickup_prefab)} is not assigned to {nameof(ItemPickGeneratorBehaviour)} of {name}");
            }
#endif
        }
